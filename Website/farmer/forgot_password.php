<?php
	...
	extract($_POST);
	include("connect.php");
	$q=mysql_query("select * from tbl_farmer where email='$me' or mobile='$me'") or die("query fail");
	if(mysql_num_rows($q))
	{
		...
		echo  $body="
		<table width='50%' align='center' bordercolor='#000' bgcolor='##D5EFB0'>
  <tr>
...
<html>
<head>
<title>Any Farmer - Welcome To The Agro World</title>
...
<div class="login-page">
    <div class="login-main">  	
    	 <div class="login-head">
				<h1><font color="#000000">Forgot Password </font></h1>
			</div>
