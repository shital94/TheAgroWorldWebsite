...
if(isset($_SESSION['abc'])=="")
{
	...
	extract($_POST);
	 $i=$_REQUEST['rid'];
	$q1=mysql_query("select * from invoice_farmer where ifid=$i  ")or die("display fail");
    	  ...
    	  <form name="form1" method="post" action="">
    	    <table width="70%" border="0" align="center">
              <tr>
                ...
                <td width="5%">:</td>
                <td width="48%"><?php echo $data1['mc_name'];?></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
              ...
              <tr>
                ...
                <td>:</td>
                <td><?php echo $data1['wholesaler_name'];?></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
              <tr>
                <td> Shop Name </td>
                <td>:</td>
                <td><?php echo $data1['shop_name'];?></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
              <tr>
                <td> Shop Address </td>
                <td>:</td>
                <td><?php echo $data1['shop_address'];?></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
...
alert("Invoice of Farmer Deleted");
</script>
<?php } ?>	