...
include("connect.php");
$i=$_REQUEST['rid'];
$q11=mysql_query("select * from tbl_products_farmer where pfid=$i")or die ("Query Failed");
...
<div class="inner-block">
    <div class="blank">
    	<h2 align="center"> Farmer Product Details </h2>
    	<div class="blankpage-main">
    		
    	  <form name="form1" method="post" action="" >
    	    <table width="50%" border="1" align="center">
              <tr>
                <td colspan="3"><div align="center">Farmer Product Details </div></td>
                </tr>
              <tr>
              ...
              <tr>
                <td> Pic1	</td>
                <td>:</td>
                <td><img src="prod_img_f/<?php echo $data11['pic1'];?>" height="100" width="150"></td>
              </tr>
              <tr>
                <td> Pic2	</td>
                <td>:</td>
                <td><img src="prod_img_f/<?php echo $data11['pic2'];?>" height="100" width="150"></td>
              </tr>
              <tr>
                <td>Pic3</td>
                <td>:</td>
                <td><img src="prod_img_f/<?php echo $data11['pic3'];?>" height="100" width="150"></td>
              </tr>
