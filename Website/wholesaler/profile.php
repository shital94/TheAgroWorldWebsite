...
if(isset($_REQUEST['save'])=="true")
{
	...
	mysql_query("update  tbl_wholesaler set wname='$nm',shop_name='$snm',shop_address='$add', pincode='$pin', mobile='$mob', details='$det',email='$em', w_pic='$fn' where w_id=$ii")or die ("QF");
...
<div class="climate">
  ...
  <tr>
    <td width="32%">Login ID </td>
    <td width="3%">:</td>
    <td width="65%"><input name="lid" type="text" id="lid" value="<?php echo $dataa['w_login'];?>" readonly=""></td>
  </tr>
  <tr>
    <td> Name	</td>
    <td>:</td>
  ...
  <tr>
    <td> Shop Address	</td>
    <td>:</td>
    <td><textarea name="sadd" id="sadd"><?php echo $dataa['shop_address'];?></textarea></td>
  </tr>
  <tr>
    <td> Pincode	</td>
    <td>:</td>
