...
<div class="inner-block">
    <div class="blank">
    	<h2 align="center">Manage Wholesaler Product  </h2>
    	  ...
    	  <form name="form1" method="post" action="">
    	    <table width="90%" border="1" align="center" >
              <tr>
                ...
                <td width="16%"><div align="center">Main Cat Name</div></td>
                <td width="15%"><div align="center">Sub Cat Name </div></td>
                <td width="13%"><div align="center">Quantity</div></td>
                <td width="12%"><div align="center">Rate</div></td>
			  ...
			  <?php
						include("connect.php");					
						$no=1;
						$q=mysql_query("select * from tbl_products_wholesaler") or die("display Fail");
			...
			?>
              ...
              <tr>
                ...
                <td width="15%"><div align="center"><a href="product_wholesal_del.php?did=<?php echo $data['pwid'];?>" onClick="return fun1();">Delete</a></div></td>
                <td width="11%"><div align="center"><a href="product_wholesal_update.php?uid=<?php echo $data['pwid'];?>" onClick="return fun2();">Update</a></div></td>
                <td width="13%"><div align="center"><a href="product_wholesal_read.php?rid=<?php echo $data['pwid'];?>">Read More</a> </div></td>
              </tr>
...
<?php if(isset($_REQUEST['wfadd'])=="1") { ?>
<script language="javascript">
alert("Product of Grocery Store Added");
</script>
<?php } ?>

<?php if(isset($_REQUEST['wfdel'])=="1") { ?>
<script language="javascript">
alert("Product of Grocery Store Deleted");
</script>
<?php } ?>

<?php if(isset($_REQUEST['pwup'])=="1") { ?>
<script language="javascript">
