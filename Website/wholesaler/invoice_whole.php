    	  ...
    	  <form name="form1" method="post" action="">
    	    <table width="89%" border="1" align="center" class="table-responsive" >
              <tr>
                ...
                <td width="34%"><div align="center">Main Category Name </div></td>
                <td width="18%"><div align="center">Wholesaler Name  </div></td>
			  ...
			  <?php
						include("connect.php");					
						$no=1;
						$q=mysql_query("select * from  invoice_wholesaler") or die("display Fail");
			...
			?>
              ...
              <tr>
                <td height="99"><div align="center"><?php echo $no;?></div></td>
                <td><div align="center"><?php echo $data['mc_name'];?></div></td>
                <td><div align="center"><?php echo $data['grocerystore_name'];?>	</div></td>
                <td><div align="center"><?php echo $data['net_amount'];?></div></td>
                <td width="16%"><div align="center"><a href="invoice_whole_del.php?did=<?php echo $data['iwid'];?>" onClick="return fun1();">Delete</a></div></td>
                <td width="18%"><div align="center"><a href="invoice_whole_read.php?rid=<?php echo $data['iwid'];?>" onClick="return fun2();">Read More</a></div></td>
              </tr>
