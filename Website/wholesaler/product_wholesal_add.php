...
if(isset($_REQUEST['add'])=="wf")
{
	...
	mysql_query("insert into tbl_products_wholesaler (mc_name,sc_name,qty,rate,weight_type,date,description,pic1,pic2,pic3) values ('$mc','$sc','$qt','$rt','$wt','$dt','$des','$fn1','$fn2','$fn3')") or die(" Insert failed");
	header("location:product_wholesal_show.php?wfadd=1");
...
<div class="inner-block">
    <div class="blank">
    	<h2 align="center">Add Product Of Wholesaler </h2>
    	<div class="blankpage-main">
    		 <div class="inbox-details-body">
    		 <div class="login-block">
				<form method="post" enctype="multipart/form-data" name="form1" id="form1" >
			<input type="hidden"  name="add" value="wf">
