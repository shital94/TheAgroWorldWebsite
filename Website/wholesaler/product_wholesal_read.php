...
include("connect.php");
$i=$_REQUEST['rid'];
$q11=mysql_query("select * from tbl_products_wholesaler where pwid=$i")or die ("Query Failed");
...
<div class="inner-block">
    <div class="blank">
    	<h2 align="center"> Wholesaler Product Details </h2>
    	<div class="blankpage-main">
    		
    	  <form name="form1" method="post" action="" >
    	    <table width="50%" border="1" align="center">
              <tr>
                <td colspan="3"><div align="center">Wholesaler Product Details </div></td>
                </tr>
              <tr>
              ...
              <tr>
                <td> Pic1	</td>
                <td>:</td>
                <td><img src="prod_img_w/<?php echo $data11['pic1'];?>" height="100" width="150"></td>
              </tr>
              <tr>
                <td> Pic2	</td>
                <td>:</td>
                <td><img src="prod_img_w/<?php echo $data11['pic2'];?>" height="100" width="150"></td>
              </tr>
              <tr>
                <td>Pic3</td>
                <td>:</td>
                <td><img src="prod_img_w/<?php echo $data11['pic3'];?>" height="100" width="150"></td>
              </tr>
