...
if(isset($_REQUEST['login'])=="true")
{
	extract($_POST);
	include("connect.php");
	$q=mysql_query("select * from   tbl_wholesaler where w_login='$lid' and password='$pwd'") or die("Query Fail");
	if(mysql_num_rows($q))
	{
		$data=mysql_fetch_array($q);
		$_SESSION['abc']=$data['w_id'];
...
<div class="login-page">
    <div class="login-main">  	
    	 <div class="login-head">
				<h1 class="style1"><font color="#000033">Wholesaler Login Panel</font></h1>
	  </div>
			<div class="login-block">
				<form id="form1" name="form1" method="post">
			<input type="hidden"  name="login" value="true">	
					<input name="lid" type="text" id="lid" placeholder="Email" required="">
