...
if(isset($_REQUEST['add'])=="city")
{
	...
	mysql_query("insert into  tbl_city
 (s_name,c_name) values ('$st','$city')") or die(" Insert failed");
	header("location:city_show.php?ctadd=1");
    ...
    <div class="blank">
    	...
    	<div class="blankpage-main">
			...
			<table width="77%" border="1" align="center">
              <tr>
                <td colspan="3"><div align="center"> City Name Here </div></td>
                </tr>
              <tr>
                <td>Select State </td>
                <td>:</td>
                <td><select name="st" id="st" required="">
                  <option value="Select State" selected>Select State</option>
                  <?php
				 $qs=mysql_query("select * from tbl_state order by s_name")or die ("QF");
				 while($datas=mysql_fetch_array($qs))
				 {
				 ?>
                  <option value="<?php echo $datas['s_name'];?>"><?php echo $datas['s_name'];?></option>
                  <?php
				}
				?>
                </select></td>
              ...
              <tr>
                ...
                <td width="5%">:</td>
                <td width="58%"><input name="city" type="text" id="city" required=""></td>
               </tr>
              <tr>
