...
<div class="inner-block">
    <div class="blank">
    	<h2 align="center" class="style1">Manage Inquiry Information </h2>
    	  ...
    	  <form name="form1" method="post" action="" id="form1">
    	    <table width="77%" height="80" border="3" align="center" bordercolor="#996666" bgcolor="#66CCCC" >
              <tr>
                ...
                <td width="9%"><div align="center">Name</div></td>
                <td width="12%"><div align="center">Address</div></td>
                <td width="12%"><div align="center">Pincode</div></td>
                <td width="12%"><div align="center">Mobile</div></td>
                <td width="12%"><div align="center">Email</div></td>
                <td width="15%"><div align="center">Comments</div></td>
			  ...
			  <?php
						include("connect.php");					
						$no=1;
						$q=mysql_query("select * from inquiry_mgmt") or die("display Fail");
			...
			?>
              ...
              <tr>
                ...
                <td><div align="center"><?php echo $data['comments'];?></div></td>
                <td width="15%"><div align="center"><a href="inquiry_del.php?did=<?php echo $data['iid'];?>" onClick="return fun1();">Delete</a></div></td>
