...
include("connect.php");
$i=$_SESSION['abc'];
$q=mysql_query("select * from tbl_admin where aid=$i") or die ("Query Fail");
...
if(isset($_REQUEST['change'])=="true")
{
	...
	if($old_pwd==$cpwd)
	{
		mysql_query("update tbl_admin set password='$npwd' where aid=$i")or die ("Query Failed1");
    ...
    <div class="blank">
    	...
    	<div class="blankpage-main">
			...
			<input type="hidden"  name="change" value="true">	
					<input name="lid" type="text" id="lid" readonly="" placeholder="Login ID" value="<?php echo $data['login_id'] ?>">
