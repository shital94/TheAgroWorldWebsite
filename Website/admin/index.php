...
if(isset($_REQUEST['login'])=="true")
{
	extract($_POST);
	include("connect.php");
	$q=mysql_query("select * from  tbl_admin where login_id='$lid' and password='$pwd'") or die("Query Fail");
	if(mysql_num_rows($q))
	{
		$data=mysql_fetch_array($q);
		$_SESSION['abc']=$data['aid'];
...
<div class="login-page">
    <div class="login-main">  	
    	 <div class="login-head">
				<h1><b><font color="#663333">Admin Login Panel</font></b></h1>
			</div>
