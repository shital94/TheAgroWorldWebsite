...
if(isset($_SESSION['abc'])=="")
{
	...
	include("connect.php");
	$i=$_REQUEST['rid'];
	$q=mysql_query("select * from tbl_wholesaler where w_id=$i")or die ("Query Failed");
...
<div class="inner-block">
    <div class="blank">
    	<h2 align="center"> Wholesaler Profile  </h2>
    	  ...
    	  <form name="form1" method="post" action="">
    	    <table width="50%" border="1" align="center">
              <tr>
                ...
                <td width="14">:</td>
                <td width="152"><?php echo $data['w_login'];?></td>
              </tr>
              <tr>
                <td>Name</td>
                <td>:</td>
              ...
              <tr>
                <td colspan="3"><div align="center"><a href="wholesal_show.php">Go Back</a> </div></td>
                </tr>
            </table>
    	  </form>
