...
if(isset($_REQUEST['add'])=="mc")
{
	...
	mysql_query("insert into tbl_main_cat (mc_name,pic_mcat) values ('$maincat','$fn')") or die(" Insert failed");
	header("location:main_cat_show.php?mcadd=1");
...
<div class="inner-block">
    <div class="blank">
    	<h2 align="center">Add Main Category </h2>
    	<div class="blankpage-main">
			...
			<table width="77%" border="1" align="center">
              <tr>
                <td colspan="3"><div align="center"> Main Category Name Here </div></td>
                </tr>
              <tr>
                <td>Main Category  Name </td>
                <td>:</td>
                <td><input name="maincat" type="text" id="maincat" required="" autofocus></td>
              </tr>
              <tr>
