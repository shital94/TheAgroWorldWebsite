...
if(isset($_REQUEST['add'])=="city")
{
 ...
 (gpic) values ('$fn')") or die(" Insert failed");
	header("location:show_pic.php?ctadd=1");
    ...
    <div class="blank">
    	...
    	<div class="blankpage-main">
			...
			<table width="77%" border="1" align="center">
              <tr>
                <td colspan="3"><div align="center"> Add Pic </div></td>
                </tr>
              <tr>
                <td width="37%">Upload Photo </td>
                <td width="5%">:</td>
                <td width="58%">
                  <input name="pic" type="file" id="pic" required="">               </td>
               </tr>
              <tr>
