...
<div class="inner-block">
    <div class="blank">
    	<h2 align="center">Invoice Of  Grocery Store </h2>
    	  ...
    	  <form name="form1" method="post" action="">
    	    <table width="89%" border="1" align="center" class="table-responsive" >
              <tr>
                ...
                <td width="18%"><div align="center">User Name </div></td>
			  ...
			  <?php
						include("connect.php");					
						$no=1;
						$q=mysql_query("select * from invoice_grocerystore") or die("display Fail");
			...
			?>
              ...
              <tr>
                <td height="108"><div align="center"><?php echo $no;?></div></td>
                ...
                <td width="16%"><div align="center"><a href="invoice_grocery_del.php?did=<?php echo $data['igid'];?>" onClick="return fun1();">Delete</a></div></td>
                <td width="18%"><div align="center"><a href="invoice_grocery_read.php?rid=<?php echo $data['igid'];?>" >Read More</a></div></td>
              </tr>
