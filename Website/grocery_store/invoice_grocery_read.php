...
if(isset($_SESSION['abc'])=="")
{
	...
	extract($_POST);
	$i=$_REQUEST['rid'];
	$q=mysql_query("select * from invoice_grocerystore where igid=$i")or die("display fail");
    	  ...
    	  <form name="form1" method="post" action="">
    	    <table width="70%" border="0" align="center">
              <tr>
                ...
                <td width="5%">:</td>
                <td width="48%"><?php echo $data['mc_name'];?></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
                </tr>
              ...
              <tr>
                <td colspan="3"><div align="center"><a href="invoice_grocery_del.php?did=<?php echo $data['igid'];?>">Delete	</a></div></td>
                </tr>
            </table>
    	  </form>
    	  <p>&nbsp;</p>
...
alert("Invoice of Grocerystore Deleted");
</script>
<?php } ?>	