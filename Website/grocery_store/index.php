...
if(isset($_REQUEST['login'])=="true")
{
	extract($_POST);
	include("connect.php");
	$q=mysql_query("select * from  tbl_grocerystore where g_login='$lid' and password='$pwd'") or die("Query Fail");
	if(mysql_num_rows($q))
	{
		$data=mysql_fetch_array($q);
		$_SESSION['abc']=$data['g_id'];
...
<div class="login-page">
    <div class="login-main">  	
    	 <div class="login-head">
					<h1><b><font color="#000000" size="6">Grocery Store  Login Panel</font></b></h1>
	  </div>
			<div class="login-block">
				<form id="form1" name="form1" method="post">
			<input type="hidden"  name="login" value="true">	
					<input name="lid" type="text" id="lid" placeholder="User ID" >
