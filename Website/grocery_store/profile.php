...
if(isset($_REQUEST['save'])=="true")
{
	...
	mysql_query("update  tbl_grocerystore set gname='$nm',gaddress='$sadd', pincode='$pin', mobile='$mob', details='$det',email='$em' where g_id=$ii")or die ("QF");
...
<p>&nbsp;</p>
      ...
      <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
        ...
        <table width="50%"  style="border-style:groove" align="center" bgcolor="#CC99CC">
          ...
          <tr>
            <td width="17%">Login ID </td>
            <td width="4%">:</td>
            <td width="79%"><input name="lid" type="text" id="lid" value="<?php echo $dataa['g_login'];?>" readonly=""></td>
          </tr>
          <tr>
            <td> Name </td>
            <td>:</td>
            <td><input name="nm" type="text" id="nm" value="<?php echo $dataa['gname'];?>"></td>
          </tr>

          <tr>
            <td> Shop Address </td>
            <td>:</td>
            <td><textarea name="sadd" id="sadd"><?php echo $dataa['gaddress'];?></textarea></td>
          </tr>
          <tr>
            <td> Pincode </td>
            <td>:</td>
