...
include("connect.php");
$i=$_SESSION['abc'];
$q=mysql_query("select * from tbl_grocerystore where g_id=$i") or die ("Query Fail");
...
if(isset($_REQUEST['change'])=="true")
{
	...
	if($old_pwd==$cpwd)
	{
		mysql_query("update tbl_grocerystore set password='$npwd' where g_id=$i")or die ("Query Failed1");
    ...
    <div class="blank">
    	...
    	<div class="blankpage-main">
			...
			<input type="hidden"  name="change" value="true">	
					<input name="lid" type="text" id="lid" placeholder="Login ID" value="<?php echo $data['g_login'] ?>">
...
function fun2()
{
	...
	{
		alert("New and Confirm passwor not match");
		form1.npwd.value='';
		form1.rpwd.value='';
		form1.npwd.focus();
		return false;
