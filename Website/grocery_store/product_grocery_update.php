...
if(isset($_SESSION['abc'])=="")
{
	...
	extract($_POST);
	$i=$_REQUEST['uid'];
	$q1=mysql_query("select * from  tbl_products_grocerystore where pgtid=$i")or die("display fail");
	$data1=mysql_fetch_array($q1);
	$oldfn=$data1['pic1'];
	$oldfn=$data1['pic2'];
	$oldfn=$data1['pic3'];
	
if(isset($_REQUEST['up'])=="pgt")
{
	 
	 
	mysql_query("update  tbl_products_grocerystore set qty='$qt', rate='$rt', date='$dt', description='$des' where pgtid=$i") or die(" Update failed");
	header("location:product_grocery_show.php?pgup=1");
}
...
<div class="inner-block">
    <div class="blank">
    	<h2 align="center"> Update Product Grocery Store </h2>
    	<div class="blankpage-main">
    		 <div class="inbox-details-body">
    		 <div class="login-block">
				<form id="form1" name="form1" method="post" enctype="multipart/form-data">
				<input type="hidden" name="up" value="pgt">
  ...
  <tr>
    <td> Pic1</td>
    <td>:</td>
    <td><img src="prod_img_g/<?php echo $data1['pic1']; ?>" width="100" height="100"></td>
  </tr>
  <tr>
    <td> Pic2	</td>
    <td>:</td>
    <td><img src="prod_img_g/<?php echo $data1['pic2']; ?>" width="100" height="100"></td>
  </tr>
  <tr>
    <td> Pic3</td>
    <td>:</td>
    <td><img src="prod_img_g/<?php echo $data1['pic3']; ?>" width="100" height="100"></td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
    </tr>
